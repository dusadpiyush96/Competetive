...
public static SinglyLinkedListNode mergeLists(SinglyLinkedListNode headA, SinglyLinkedListNode headB) {
    ...
    fin.head = new SinglyLinkedListNode(0);
    SinglyLinkedListNode l = fin.head;
    SinglyLinkedListNode prev = fin.head;
    //boolean first_insrn = false;
    //l.next = new SinglyLinkedListNode(0);
    while(a!=null && b!=null){
        if(a.data>b.data) {
            l.data=b.data;
            l.next =new SinglyLinkedListNode(0);
